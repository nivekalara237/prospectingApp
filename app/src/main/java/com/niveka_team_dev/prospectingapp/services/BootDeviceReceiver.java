...
public class BootDeviceReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //le system vient d'etre demarré. checker si l'user et coursier et demarré LocationMonitoringService.class

//        if (UserHelpers.hasRole(context, Utils.ROLES_POSSIBLE.COURSIER)){
//            LocationHelper.startLocationMonitoringService(context);
//        }
